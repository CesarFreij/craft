...
import { Box, Paper, Typography, Tooltip, IconButton, Menu, MenuItem, Divider, TextField, FormControlLabel, Switch, Dialog, DialogActions, DialogContent, DialogTitle, InputAdornment, Chip, Alert, Skeleton } from '@mui/material'
...
import { FiFolder, FiClipboard, FiTrash2, FiEdit2, FiPlus, FiSearch, FiScissors, FiCopy, FiBox, FiMoreHorizontal, FiChevronRight, FiRefreshCw, FiFileText, FiMinimize2, FiMaximize2 } from "react-icons/fi";
import { MaterialType, FormValues } from './types/Material';
